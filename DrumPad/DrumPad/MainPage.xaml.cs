...
namespace DrumPad
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        void LoadSamples(int index)
        {
            ...
            players[(int)DrumType.Bass1].Load(GetStreamFromFile($"Audio.bd1.wav"));
            players[(int)DrumType.Bass2].Load(GetStreamFromFile($"Audio.bd2.wav"));
            players[(int)DrumType.Clap].Load(GetStreamFromFile($"Audio.sd2.wav"));
            players[(int)DrumType.HiHat1].Load(GetStreamFromFile($"Audio.hh1.wav"));
            players[(int)DrumType.HiHat2].Load(GetStreamFromFile($"Audio.hh2.wav"));
            players[(int)DrumType.Shake].Load(GetStreamFromFile($"Audio.bd1.wav"));
            players[(int)DrumType.Snare1].Load(GetStreamFromFile($"Audio.sd1.wav"));
            players[(int)DrumType.Snare2].Load(GetStreamFromFile($"Audio.sd2.wav"));
            players[(int)DrumType.TomTom].Load(GetStreamFromFile($"Audio.tt1.wav"));
        }
